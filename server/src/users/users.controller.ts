import { Controller, Get, Post, Body, Patch, Param, Delete, HttpCode, BadRequestException, UseGuards, UseInterceptors, ClassSerializerInterceptor } from '@nestjs/common';
